...
const Hero = () => {
  ...
  return (
    <div 
      className="relative lg:h-[24em] md:h-[18em] max-sm:h-[12em] mt-[80px] overflow-hidden"
    ...
    >
      <div
        className="w-full h-full mt-2 bg-[#4361ee]  bg-cover bg-center bg-no-repeat aspect-square"
