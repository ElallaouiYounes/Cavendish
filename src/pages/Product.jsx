        ...
        <div className="flex flex-col gap-4 lg:w-2/4 lg:pl-9 max-lg:w-full max-lg:items-center">
          ...
          <div className="flex flex-row items-center gap-12">
            <Link to={`/checkout/${product.id}`}>
              <button className="bg-violet-800 text-white font-semibold py-3 px-16 rounded-xl h-full w-[415px]">
                Buy Now
              </button>
            </Link>
          </div>
          ...
          <div className="flex flex-row items-center gap-6 mt-6">
            ...
            <div className="flex flex-row items-center justify-center gap-6 w-full">
              ...
              <Tooltip title="share" placement="bottom">
                <IoShareSocialSharp className="cursor-pointer text-gray-500 text-3xl hover:text-blue-500 hover:scale-110 transition-transform" />
              </Tooltip>
            </div>
          </div>
        </div>
